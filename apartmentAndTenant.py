...
#Also includes tenant stuff, could be moved to a separate file
...
class ApartmentManager:
    ...
    def assign_tenant(self, tenant_id, apartment_id, lease_period, lease_start, lease_end):
        """
    ...
    def insert_mock_data(self):
        ...
        #tenants
        cursor.executemany("""
            INSERT INTO tenants (location, full_name, email, phone, ni_number, occupation, tenant_references, apartment_id, lease_period, lease_start, lease_end, deposit_amount, monthly_rent)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        """, [
            ("Bristol", "Alice Johnson", "alice@example.com", "07123456789", "AB123456C", "Engineer", "Paul Jones", 1, "12 months", "01-01-2025", "01-01-2026", 1200, 1200),
            ("London","Ben Smith", "ben@example.com", "07234567890", "CD234567D", "Teacher", "Alan Brown", 4, "12 months", "01-02-2025", "01-02-2026", 2500, 2500),
